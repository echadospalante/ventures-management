...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/carolina.cardona/Documents/udea/proyecto_integrador/ventures-management/src/app/config/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/carolina.cardona/Documents/udea/proyecto_integrador/ventures-management/src/app/config/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "04b2b317ceb19968690b4e2f94f09e024d8b22f3a0bb7f9b1d80acaa468ce7b2",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/app/config/prisma/client",
    "app/config/prisma/client",
  ]
...
path.join(process.cwd(), "src/app/config/prisma/client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/app/config/prisma/client/schema.prisma")
